...
public class XMLHandler extends DefaultHandler {
	...
	public void startElement(String namespaceURI, String localName,
		...
		if (localName.equals(el)) {
			...
			myParsedExampleDataSet.setaw(attrValue);
			...
			myParsedExampleDataSet.setden(attrValue);

			attrValue = atts.getValue("meltpt");
			myParsedExampleDataSet.setmeltpt(attrValue);

			attrValue = atts.getValue("boilpt");
			myParsedExampleDataSet.setboilpt(attrValue);
			...
			myParsedExampleDataSet.setionen(attrValue);
